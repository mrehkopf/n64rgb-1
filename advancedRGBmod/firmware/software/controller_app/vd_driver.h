...
// some macros
#define VD_SET_ADDR(h,v) IOWR_ALTERA_AVALON_PIO_DATA(VD_WRADDR_BASE,((h<<VD_WRADDR_HSHIFT_OFFSET) & VD_WRADDR_H_ANDMASK) | (v & VD_WRADDR_V_ANDMASK))
#define VD_SET_DATA(c,f) IOWR_ALTERA_AVALON_PIO_DATA(VD_WRDATA_BASE,((c<<VD_WRDATA_COLOR_OFFSET) & VD_WRDATA_COLOR_ANDMASK) | (f & VD_WRDATA_FONT_ANDMASK))
