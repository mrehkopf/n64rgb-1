...
`define _n64a_params_vh_
  ...
  `define vdata_i_s     3*color_width_i+3:3*color_width_i
  `define vdata_i_r     3*color_width_i-1:2*color_width_i
  `define vdata_i_g     2*color_width_i-1:  color_width_i
  `define vdata_i_b       color_width_i-1:0
